...
class Topics(models.Model):
    ...
    sound_url = models.CharField(max_length=128, db_index=False, unique=False, verbose_name="--")
    meta_sound_url = models.CharField(max_length=128, db_index=False, unique=False, verbose_name="--")
